      ...
      >
        ...
        >
          ...
          <article className="relative z-10 max-w-xl p-8 text-primary-foreground sm:p-12">
            ...
            <span className="mt-7 block h-1 w-16 rounded-full bg-primary" aria-hidden="true" />
        ...
        <section className="flex min-h-0 min-w-0 items-center justify-center bg-card px-6 py-12 sm:px-10 md:px-12 lg:px-16">
          <article className="min-w-0 w-full max-w-md text-center">
            ...
            <Button
              type="button"
              variant="outline"
              className="mt-12 h-auto min-h-16 w-full border-border bg-card px-5 text-base font-semibold shadow-none hover:bg-accent"
