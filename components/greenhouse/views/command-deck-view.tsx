  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col gap-4 border-b border-border/70 pb-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Badge variant="outline" className="w-fit rounded-full border-border bg-white px-3 py-1 text-muted-foreground">{online ? "เชื่อมต่อแอปแล้ว" : "การเชื่อมต่อแอปขาดหาย"} · ตรวจสอบ {lastUpdated}</Badge>
      </section>
